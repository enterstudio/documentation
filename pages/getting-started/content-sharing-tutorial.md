...
1. In the [Branch Dashboard](https://dashboard.branch.io) create a new app by selecting “Create new app” from the drop down menu in the top right corner
...
3. Go to the [Settings](https://dashboard.branch.io/settings) page from the left hand navigator in the Branch dashboard
...
5. In the “Identifier” text field, input the “Bundle Identifier” from the General tab that is located in your **project _file_**
6. In the "URI Schemes" text field, input a URI scheme of your choice
...
6. Go to Settings in the Branch Dashboard and go to [Link Settings](https://dashboard.branch.io/settings/link) in the top navigation bar
...
*Strong Matching is a Branch feature that allows Branch to recognize indiviudals that it has interacted with before- creating a more streamlined and personal experience*
...
12. Edit “Objective-C Bridging Header” so that its Tutorial Helper column reads: YourAppName/Your-Bridging-Header.h (this lets Xcode know where to look for the bridging header)
  {% example %}
